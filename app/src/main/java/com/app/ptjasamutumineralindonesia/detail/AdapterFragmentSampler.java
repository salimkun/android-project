...
public class AdapterFragmentSampler extends FragmentStatePagerAdapter {

    private int numOfTabs;
    private String idAssignment;
    private String idAssignmentDocNumber;
    public AdapterFragmentSampler(FragmentManager fm, int numOfTabs, String idAssignment, String idAssignmentDocNumber) {
        super(fm);
    ...
    public AdapterFragmentSampler(FragmentManager fm) {
        super(fm);
    }
    @Override
